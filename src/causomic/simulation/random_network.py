...
Generates random/structured ground-truth DAGs and simulates INDRA-style prior
networks with controllable misspecification for graph-recovery experiments.
"""
