...
BENCHMARK_CONFIGS: list[BenchmarkConfig] = [
    ...
    # ── Sample-size sweep (AICGaussIndraPriors, moderate noise) ──────────
    BenchmarkConfig(
        name="AICGaussIndraPriors_low_replicates",
    ...
    BenchmarkConfig(
        name="AICGaussIndraPriors_mid_replicates",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=2.0,
        fake_edge_multiplier=5.0,
        n_samples=_N_MID,
    ...
    BenchmarkConfig(
        name="AICGaussIndraPriors_high_replicates",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=2.0,
        fake_edge_multiplier=5.0,
        n_samples=_N_HIGH,
...
if __name__ == "__main__":
    ...
    out_path = "AICGaussIndraPriors_benchmark_results.csv"
    results.to_csv(out_path, index=False)
    print(f"\nTrial results saved to {out_path}")

    # Save per-node interventional results
    if not node_results.empty:
        node_out_path = "AICGaussIndraPriors_benchmark_interventional_nodes.csv"
