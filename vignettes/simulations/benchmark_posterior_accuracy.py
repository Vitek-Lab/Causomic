...
BENCHMARK_CONFIGS: list[BenchmarkConfig] = [
    ...
    # ── Scoring function comparison (moderate noise) ─────────────────────
    BenchmarkConfig(
        name="BICNoPriors_moderate_noise",
    ...
    BenchmarkConfig(
        name="BICIndraPriors_moderate_noise",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=1.0,
        fake_edge_multiplier=2.0,
    ...
    BenchmarkConfig(
        name="AICIndraPriors_moderate_noise",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=1.0,
        fake_edge_multiplier=2.0,
    ...
    # ── Noise level sweep (BICGaussIndraPriors) ───────────────────────────
    BenchmarkConfig(
        name="BICIndraPriors_low_noise",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=0.5,
        fake_edge_multiplier=1.0,
        scoring_function=BICGaussIndraPriors,
        seeds=_SEEDS,
    ),
    BenchmarkConfig(
        name="BICIndraPriors_high_noise",
        dag_params=_DAG_PARAMS,
    ...
    BenchmarkConfig(
        name="BICIndraPriors_low_replicates",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=1.0,
        fake_edge_multiplier=2.0,
        n_samples=_N_LOW,
    ...
    BenchmarkConfig(
        name="BICIndraPriors_mid_replicates",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=1.0,
        fake_edge_multiplier=2.0,
        n_samples=_N_MID,
    ...
    BenchmarkConfig(
        name="BICIndraPriors_high_replicates",
        dag_params=_DAG_PARAMS,
        fake_node_multiplier=1.0,
        fake_edge_multiplier=2.0,
        n_samples=_N_HIGH,
...
if __name__ == "__main__":
    ...
    if not node_results.empty:
        node_out_path = "benchmark_interventional_nodes.csv"
